...
# hiplog create-item --timestamp 2015-10-30T00:00:00 --type hips --id 2015:hips:2 --parent 2015:hips:1 --note notes/fake/fake.md # should raise InvalidParent because of timestamp
